...
const technicalEvents: Event[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      'Code length is the primary scoring factor.',
      'Participants must bring their own laptops for the event.',
      'The competition consists of three rounds (The Sprint, The Character Crunch, The Master Stroke).',
      'Must produce correct output for all test cases.',
    ...
    judgingCriteria: [
      'Round 1 (The Sprint): 2 simple problems. Ranked primarily on code size, secondary on submission time. Top 10-15 advance.',
      'Round 2 (The Character Crunch): 2 intermediate algorithmic problems. Scoring based on Character Count. Top 6 advance.',
      'Round 3 (The Master Stroke): 1 complex logic puzzle. Scoring based on Character Count and Submission time. Top 3 awarded.',
    ],
  },
  {
    title: 'BUZZER BYTES',
...
const nonTechnicalEvents: Event[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      'Participants must bring their own materials (laptop, tablet, ipad).',
    ...
    judgingCriteria: [
      'Creativity & Design (Round 1): Visual appeal, layout',
  ...
  },
  {
    ...
    icon: Compass,
    color: '#a855f7',
    desc: 'A campus-based treasure hunt event designed to test participants’ problem-solving, teamwork, and critical thinking skills. Teams navigate through different locations on campus by decoding clues and solving puzzles at each stage.',
    ...
    judgingCriteria: [
      'The first team to complete the final task wins.',
      'If no team finishes in time, the team with the most fragment cards wins.',
      'In case of a tie, the team that reached the final stage earlier wins.',
      'If still tied, the team with fewer mistakes wins.',
      'Breaking rules or cheating leads to penalty or disqualification.',
      'Power Cards do not affect judging.',
  ...
  },
  {
    ...
    icon: Paintbrush,
    color: '#a855f7',
    desc: 'A creative platform to visually represent technological concepts through artistic expression on the face. Disclaimer: A participation fee of ₹100 will be charged per team.',
    teamSize: '2 members',
    duration: '60 minutes',
    venue: 'APJ 107',
    rules: [
      'The event is open to teams of 2 members (artist and model). Disclaimer: A participation fee of ₹100 will be charged per team.',
